...
<body>
	...
	<header>
		<div id ="Head1">
			<a href="index.php?cible=gestionnaire"><img src = "view/Images/logobase.png" alt="Logo" width="70"></a>
      ...
      <div id="Head2"> <br />
      <?php if (basename($_SERVER['REQUEST_URI'])=='index.php?cible=gestionnaire&action=see_Accueil_Gestionnaire'):?>
			<p> Bonjour
			<?php
			recupereCivilite($bdd, $_SESSION["email"]); 
			echo(" ");
			recupereNom($bdd, $_SESSION["email"]);?></p>
     	<?php elseif (basename($_SERVER['REQUEST_URI'])=='index.php?cible=gestionnaire'):?>
		 	<p> Bonjour
			<?php
			recupereCivilite($bdd, $_SESSION["email"]); 
			echo(" ");
			recupereNom($bdd, $_SESSION["email"]);?></p>
			<?php elseif (basename($_SERVER['REQUEST_URI'])=='index.php?cible=gestionnaire&action=see_Statistiques_Gestionnaire'):?>
			<p> Statistiques Globales</p>
			<?php elseif (basename($_SERVER['REQUEST_URI'])=='index.php?cible=gestionnaire&action=see_Tdb_Gestionnaire'):?>
			<p> Tableau de Bord</p>
			<?php elseif (basename($_SERVER['REQUEST_URI'])=='index.php?cible=gestionnaire&action=see_Sav_Gestionnaire'):?>
			<p> SAV</p>
            <?php elseif (basename($_SERVER['REQUEST_URI'])=='index.php?cible=gestionnaire&action=see_Faq_Gestionnaire'):?>
			<p> FAQ</p>
			<?php elseif (basename($_SERVER['REQUEST_URI'])=='index.php?cible=gestionnaire&action=see_Cgu_Gestionnaire'):?>
	...
	<div id="Navigation">
		...
		<div id="titre">
			...
			<button><a href="index.php?cible=gestionnaire&action=see_Accueil_Gestionnaire">Accueil</a></button><br />
            <button><a href="index.php?cible=gestionnaire&action=see_Tdb_Gestionnaire">Tableau de Bord</a></button><br />
			<button><a href="index.php?cible=gestionnaire&action=see_Statistiques_Gestionnaire">Statistiques</a></button><br />
		    <button><a href="index.php?cible=gestionnaire&action=see_Sav_Gestionnaire">SAV</a></button><br />
	...
	<footer>
        	...
        	<div id = "Footer3">
	            ...
	            <a href = "index.php?cible=gestionnaire&action=see_Faq_Gestionnaire"><u> FAQ </u></a> -
	            <a href = "mailto:<?php echo getEmailContact($bdd)?>"><u>Nous contacter</u></a> -
	            <a href = "index.php?cible=gestionnaire&action=see_Cgu_Gestionnaire"><u> Conditions générales d'utilisation </u></a> -
