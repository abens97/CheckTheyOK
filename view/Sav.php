...
<div id="liste_incidents">
                ...
                <ul>
                    <?php foreach ($incidents as $incident) { ?>
                        <li><a href="index.php?cible=user&action=see_Sav&ticket=<?=$incident['id_incident']?>">Incident n°<?= $incident["id_incident"]; ?> <?php echo' - '; echo $incident["resolu"]; ?></a></li>
                    <?php } ?>
                </ul>
...
if ($incident_choisi['id_incident'] != 0){
                ...
                echo "</ul>";
                echo "<form method='post' action='index.php?cible=user&action=add_message&ticket=$incident_choisi_id'>
