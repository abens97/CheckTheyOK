...
<body>
	...
	<header>
		<div id ="Head1">
			<a href="index.php?cible=user&action=see_Accueil_User"><img src = "view/Images/logobase.png" alt="Logo" width="70"></a>
        ...
        <div id="Head2"> <br />
			<?php if (basename($_SERVER['REQUEST_URI'])=='index.php?cible=user&action=see_Accueil_User'):?>
			<p> Bonjour
      <?php 
			recupereCivilite($bdd, $_SESSION["email"]);
			echo(" ");
			recupereNom($bdd, $_SESSION["email"]);?></p>
			<?php elseif (basename($_SERVER['REQUEST_URI'])=='index.php?cible=user'):?>
			<p> Bonjour
			<?php 
			recupereCivilite($bdd, $_SESSION["email"]); 
			echo(" ");
			recupereNom($bdd, $_SESSION["email"]);?>
			<?php elseif (basename($_SERVER['REQUEST_URI'])=='index.php?cible=user&action=see_Programmer'):?>
			<p> Programmer sa maison </p>
			<?php elseif (basename($_SERVER['REQUEST_URI'])=='index.php?cible=user&action=see_Logements'):?>
			<p> Configurer ses logements</p>
			<?php elseif (basename($_SERVER['REQUEST_URI'])=='index.php?cible=user&action=see_Statistiques'):?>
	...
	<div id="Navigation">
		...
		<div id="titre">
			<i>Menu</i>
				...
				<button><a href="index.php?cible=user&action=see_Accueil_User">Accueil</a></button><br />
				<button><a href="index.php?cible=user&action=see_Statistiques">Journal</a></button><br />
		    <button><a href="index.php?cible=user&action=see_Programmer">Programmer</a></button><br />
		    <button><a href="index.php?cible=user&action=see_Logements">Logements</a></button><br />
		    <button><a href="index.php?cible=user&action=see_Sav">S.A.V.</a></button><br />
	...
	<footer>
        	...
        	<div id = "Footer3">
	            ...
	            <a href = "index.php?cible=user&action=see_Faq_User"><u> FAQ </u></a> -
	            <a href = "mailto:<?php echo getEmailContact($bdd)?>"><u>Nous contacter</u></a> -
	            <a href = "index.php?cible=user&action=see_Cgu_User"><u> Conditions générales d'utilisation </u></a> -
