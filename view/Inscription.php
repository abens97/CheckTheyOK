...
<head>
    ...
    <style type="text/css">
        ...
        h2{font-size: 120%;}
        .form2 {width:80%;margin:0 auto;display:table;margin-top: 8%;background-color: white;padding: 9px; border-radius: 8px;background-color:rgb(255, 255, 255,0.7);transition:0.5s;}
        ...
        #form2_demi, #form3_demi label {font-family:"Century Gothic";font-style: normal;  }
        
        #form2_demi, #form2_bas, #form3_demi  {float: left;width:50%;-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;display: table-cell;padding-top: 1%;}input, button {opacity: 0.8;font-family: normal;}
        input, button {opacity: 0.8;font-family: normal;}
        @media only screen and (min-width: 48em) { #form2_demi {width: 25%;}}
        @media only screen and (min-width: 48em) { #form2_bas {width: 50%;}}
