<?php
/* !empty($_POST['nom']) AND !empty($_POST['prenom']) AND !empty($_POST['numero_telephone']) AND !empty($_POST['email']) AND !empty($_POST['mot_de_passe']) AND !empty($_POST['mot_de_passe2']) */ 
