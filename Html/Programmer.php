...
<style type="text/css">
		...
		#section {background-color: white; opacity: 0.7;  border-radius: 18%;  text-align: center;display: table; margin: 0 auto;}
...
<html>
		<div id = "section">
			<a href = "http://www.facebook.com" target="_blank"><div id = "carre1"><br /><img src="../Images/lumiere.png"  alt="Lumière" width="80"> <br /><h3>Lumière</h3></div></a>
			<a href = "http://www.facebook.com" target="_blank"><div id = "carre2"><br /><img src="../Images/temperature.png"  alt="Température" width="80"> <br /><h3>Température</h3></div></a>
			<a href = "http://www.facebook.com" target="_blank"><div id = "carre3"><br /><img src="../Images/volets.png"  alt="Volets" width="80"> <br /><h3>Volets</h3></div></a>
			<a href = "http://www.facebook.com" target="_blank"><div id = "carre4"><br /><img src="../Images/ventilateur.png"  alt="Ventilateur" width="80"> <br /><h3>Ventilateur</h3></div></a>
		</div>
