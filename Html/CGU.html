...
<head>
	...
	* {-moz-box-sizing: border-box; box-sizing: border-box;}
		...
		header { background-color: white; opacity: 0.7; display :table-header-group; left:0;top:0;text-align: center;}
		...
		footer {opacity: 0.7; width: 100%; background-color: white; bottom: 0; left: 0; right: 0; position:absolute; color:black;display : table-row;text-align: center;}
