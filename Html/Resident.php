...
<head>
	...
	* {-moz-box-sizing: border-box; box-sizing: border-box;}
		body {background-color: #000000; color: white; text-align: center;height:100%;width:100%;background: url(../Images/H.jpg);background-size:cover;display : table; background-position: fixed; }
		header { background-color: white; opacity: 0.7; display :table-header-group; left:0;top:0;}
		...
		#Navigation{background-color: white; opacity: 0.8; float: left; position:fixed;border-radius: 3%;margin-left: -0.5%;margin-top: 8%; color: black;display: table;font-family: "Jazz LET";font-size: 1.8em;}
		#Navigation button{display: table-cell;margin-left: auto;margin-right: auto; padding :0;width: 180px;transition: 0.3s;}
		...
		footer {opacity: 0.7; width: 100%; background-color: white; bottom: 0; left: 0; right: 0; position:absolute; color:black;display : table-row;}
		...
		#section {margin-top: 8%; margin-left: 30%;width: 40%; height: 100%; background-color: white; opacity: 0.7;  border-radius: 18%; position: relative; }
