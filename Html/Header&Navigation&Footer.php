...
<head>
	...
	<style type="text/css">
		...
		* {-moz-box-sizing: border-box; box-sizing: border-box;}
		...
		#Navigation{text-align: center; transition:0.8s;background-color: white; opacity: 0.8; float: left; position:fixed;border-radius: 5px;margin-top: 10%; color: black;display: table;font-family: "Jazz LET";font-size: 28px;transform:translateX(-100rem);animation: slideIn 1.2s forwards;width: 8%;}
		...
		#descente a, #descente-content input {float: right;font-size: 16px;color: white;text-align: center;text-decoration: none;}
		#descente-content {margin-left: 5%;display: none;position: absolute;background-color: #f9f9f9;min-width: 160px;box-shadow: 0px 8px 16px 0px rgba(0,0,0,0.2);z-index: 1;text-align: center;}
		#descente-content a, #descente-content input {float: none;color: grey;padding: 12px 16px;text-decoration: none;display: block;text-align: left;text-shadow: 2px 10px 7px rgba(0,0,0,0,0.2);}
		#descente-content a:hover, #descente-content input:hover { color: white;text-decoration: none;text-align: center;transition:0.8s;padding: 13%;background-color: grey;}
		#descente:hover #descente-content {transition: 2s;display: block;}
	</style>
</head>
