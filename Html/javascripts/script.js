$(function() {
	...
	function check_retype_email() {
		...
		if(email != retype_email) {
			$("#retype_email_error_message").html("Emails don't match");
	...
	$("#registration_form").submit(function() {
		...
		if(error_username == false && error_password == false && error_retype_password == false && error_email == false && error_retype_email == false) {
			return true;
		} else {
			return false;	
		}
